...
F.add_node(1, lamb=0.4, mi=0.999, R=1)
F.add_node(2, lamb=0.2, mi=0.2, R=1)
F.add_node(3, lamb=0.8, mi=0.44, R=1)
F.add_node(4, lamb=0.9, mi=0.32, R=1)
...
F.add_edge(1, 2, lamb=0.85, mi=0.85, weight=5, R=0.85)  # moze ici umjesto F.add_edge(*e1, lamb=0.85, mi=0.85, weight=5)
F.add_edge(*e2, lamb=0.85, mi=0.56, weight=6, R=0.85)
F.add_edge(*e3, lamb=0.85, mi=0.34, weight=1, R=0.85)
F.add_edge(*e4, lamb=0.85, mi=0.76, weight=2, R=0.85)
F.add_edge(*e5, lamb=0.85, mi=0.34, weight=3, R=0.85)
...
# 9.a 8.c
print(abraham(G, [[1, 2, 4], [1, 3, 4], [1, 2, 3, 4], [1, 3, 2, 4]], 'R'))
